...
export default function Home() {
 ...
 bg-origin-padding bg-top bg-no-repeat bg-cover text-white flex flex-col justify-center items-start p-8 gap-4`}
        >
          <h1 className="text-8xl tracking-widest font-bebas text-indigo-500 md:text-white">our history</h1>
          <Link href="/history">
 ...
 bg-origin-padding bg-top bg-no-repeat bg-cover text-white flex flex-col justify-center items-start p-8 gap-4`}
        >
          <h1 className="text-8xl tracking-widest font-bebas text-rose-500 md:text-white">our payload</h1>
          <Link href="/payload">
